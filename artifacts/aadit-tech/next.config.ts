...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/iso-27001-consulting-india', destination: '/compliance/iso-27001', permanent: true },
      ...
      { source: '/managed-it-services-india', destination: '/it-managed-services/managed-it-services', permanent: true },
      { source: '/managed-it-services', destination: '/it-managed-services/managed-it-services', permanent: true },
