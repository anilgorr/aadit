        ...
        <Section background="muted" className="border-b">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 max-w-2xl text-lg text-muted-foreground md:text-xl">
              Practical perspectives on cybersecurity, compliance, and managed IT from the Aadit
              Technologies team.
            </p>
          </div>
        </Section>
          ...
          {posts.length > 0 ? (
            ...
            <div className="mx-auto max-w-xl text-center">
              ...
              <p className="mx-auto mt-4 max-w-md text-muted-foreground">
                We&apos;re working on our first articles. Check back soon for insights on security,
                compliance, and managed IT.
              </p>
            </div>
          )}
        </Section>
