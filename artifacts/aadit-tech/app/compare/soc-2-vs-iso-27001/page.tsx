...
export default function Soc2VsIso27001Page() {
  const schema = [
    webPageSchema({
      path: "/compare/soc-2-vs-iso-27001",
      name: "SOC 2 vs ISO 27001: Which Do You Need First?",
      description:
        "A practical comparison of SOC 2 and ISO 27001 for Indian SaaS companies and service providers.",
    }),
    faqSchema(FAQs),
  ]
          ...
          <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-2">
            <Card className="p-7">
              ...
              <p className="mt-4 leading-relaxed text-muted-foreground">
                SOC 2 is a reporting framework based on the AICPA Trust Services Criteria. A
                Type I report evaluates control design at a point in time; a Type II report
                evaluates operating effectiveness over an observation period. It is an attestation,
                not a certificate.
              </p>
            </Card>
            <Card className="p-7">
              ...
              <p className="mt-4 leading-relaxed text-muted-foreground">
                ISO 27001 is a standard for an information security management system. It requires
                a defined scope, risk-based planning, objectives, control decisions, internal
                review, and continual improvement. Certification is issued to the organisation.
              </p>
            </Card>
          </div>
        </Section>
        ...
        <Section>
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              ...
              access, protect data, monitor operations, handle incidents, and review controls.
              That overlap is why a shared gap assessment and evidence plan can make a second
              programme more efficient than starting from scratch.
            </p>
            <h2 className="mt-10 text-2xl font-bold text-foreground">A buyer-led decision</h2>
            <p className="mt-4 leading-relaxed text-muted-foreground">
              Avoid treating either framework as a generic badge. Ask which customers are asking
              for what, which markets you serve, what scope you can operate consistently, and what
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <Link href="/compliance/iso-27001" className="font-semibold text-primary hover:underline">
